 ...
 *
 */
public abstract class AbstractBinaryExpression extends AbstractGroovyExpression {
    ...
    public AbstractBinaryExpression(GroovyExpression left, String op, GroovyExpression right) {
        this.left = left;
        this.op = op;
        this.right = right;
    }
