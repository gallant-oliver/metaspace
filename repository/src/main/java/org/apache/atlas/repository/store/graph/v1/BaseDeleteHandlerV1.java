...
public abstract class BaseDeleteHandlerV1 {
    public static final Logger LOG = LoggerFactory.getLogger(BaseDeleteHandlerV1.class);
    ...
    public BaseDeleteHandlerV1(AtlasTypeRegistry typeRegistry, boolean shouldUpdateInverseReference, boolean softDelete) {
     ...
     * Deletes any traits, composite entities, and structs owned by eFach entity.
    ...
    public Collection<GraphHelper.VertexInfo> getOwnedVertices(AtlasVertex entityVertex) throws AtlasBaseException {
        ...
        while (vertices.size() > 0) {
            ...
            for (AtlasStructType.AtlasAttribute attributeInfo : entityType.getAllAttributes().values()) {
                ...
                BaseAtlasType attrType     = attributeInfo.getAttributeType();
    ...
    public boolean deleteEdgeReference(AtlasEdge edge, TypeCategory typeCategory, boolean isOwned, boolean forceDeleteStructTrait,
        ...
        boolean bool = typeCategory == OBJECT_ID_TYPE && isOwned;
        if (typeCategory == STRUCT || typeCategory == CLASSIFICATION || bool) {
            if (LOG.isDebugEnabled()) {
    ...
    protected void deleteEdge(AtlasEdge edge, boolean updateInverseAttribute, boolean force) throws AtlasBaseException {
        ...
        if (updateInverseAttribute) {
            ...
            BaseAtlasType parentType     = typeRegistry.getType(atlasEdgeLabel.getTypeName());
    ...
    protected void deleteTypeVertex(AtlasVertex instanceVertex, boolean force) throws AtlasBaseException {
        ...
        BaseAtlasType parentType = typeRegistry.getType(typeName);
