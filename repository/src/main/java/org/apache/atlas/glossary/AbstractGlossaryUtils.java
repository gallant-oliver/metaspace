...
public abstract class AbstractGlossaryUtils {
    ...
    protected AbstractGlossaryUtils(final AtlasRelationshipStore relationshipStore, final AtlasTypeRegistry typeRegistry, final DataAccess dataAccess) {
