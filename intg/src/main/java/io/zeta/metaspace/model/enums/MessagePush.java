...
public enum MessagePush {
    ...
    USER_GROUP_PERMISSION_TECHNICAL_CATEGORY_REMOVE(1,"用户组信息","【%s】用户组的【%s】技术目录权限被移除","系统管理/用户组管理"),
    USER_GROUP_PERMISSION_TECHNICAL_CATEGORY_CHANGE(1,"用户组信息","【%s】用户组的【%s】技术目录发生权限变更","系统管理/用户组管理"),
    USER_GROUP_PERMISSION_BUSINESS_CATEGORY_REMOVE(1,"用户组信息","【%s】用户组的【%s】业务目录权限被移除","系统管理/用户组管理"),
    USER_GROUP_PERMISSION_BUSINESS_CATEGORY_CHANGE(1,"用户组信息","【%s】用户组的【%s】业务目录发生权限变更","系统管理/用户组管理"),
    ...
    USER_GROUP_PERMISSION_INDICATOR_CATEGORY_REMOVE(1,"用户组信息","【%s】用户组的【%s】业务目录权限被移除","系统管理/用户组管理"),
    USER_GROUP_PERMISSION_INDICATOR_CATEGORY_CHANGE(1,"用户组信息","【%s】用户组的【%s】业务目录发生权限变更","系统管理/用户组管理"),
