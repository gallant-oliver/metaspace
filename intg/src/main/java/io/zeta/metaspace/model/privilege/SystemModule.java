...
public enum SystemModule {
    TECHNICAL_CHECK(1,"技术数据查看"),BUSINESSE_CHECK(2,"业务对象查看"),TECHNICAL_OPERATE(3,"技术信息操作"),BUSINESSE_OPERATE(4,"业务信息操作"),BUSINESSE_MANAGE(5,"业务对象管理"),PRIVILEGE_MANAGE(6,"权限模块管理"),METADATA_MANAGE(7,"元数据管理");
    private int code;
    private String desc;
