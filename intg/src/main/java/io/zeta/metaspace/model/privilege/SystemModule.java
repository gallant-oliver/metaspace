...
public enum SystemModule {
    TECHNICAL_CHECK(1,"浏览技术信息"),BUSINESSE_CHECK(2,"浏览业务信息"),TECHNICAL_OPERATE(3,"技术信息操作"),BUSINESSE_OPERATE(4,"业务信息操作")
    ,BUSINESSE_MANAGE(5,"业务对象管理"),PRIVILEGE_MANAGE(6,"权限模块管理"),METADATA_MANAGE(7,"元数据管理"),TECHNICAL_CATALOG(8,"管理技术目录"),BUSINESSE_CATALOG(9,"管理业务目录"),API_CHECK(10,"管理API信息");
    private int code;
    private String desc;
