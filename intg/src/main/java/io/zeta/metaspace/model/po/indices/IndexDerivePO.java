...
public class IndexDerivePO {
    ...
    public String getIndexAtomicId() {
        return indexAtomicId;
    }

    public void setIndexAtomicId(String indexAtomicId) {
        this.indexAtomicId = indexAtomicId;
    }
