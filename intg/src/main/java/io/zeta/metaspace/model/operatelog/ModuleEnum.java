...
public enum ModuleEnum {
    ...
    BUSINESSMANAGE(2,"数据资产","业务对象管理",5,"业务对象管理", "businessmanage", "businessmanage",1),
    BUSINESSADMIN(2,"数据资产","业务目录编辑",9,"业务目录编辑", "businessadmin", "businessadmin",0),
    ...
    IPRESTRICTION(8,"数据服务","黑白名单管理",29,"脱敏管理","iprestriction","iprestriction",1)
    ;
