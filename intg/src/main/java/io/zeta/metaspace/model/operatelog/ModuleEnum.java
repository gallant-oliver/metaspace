...
public enum ModuleEnum {
    ...
    TECHNICALEDIT(2,"数据资产","编辑技术数据",3,"编辑技术数据", "technicaledit", "technicaledit",0),
    TECHNICALADMIN(2,"数据资产","管理技术数据",8,"管理技术数据", "technicaladmin", "technicaladmin",0),
    METADATA(2,"数据资产","元数据管理",7,"元数据管理", "metadata", "metadata",1),
    BUSINESS(2,"数据资产","查看业务对象",2,"业务对象", "business", "businessview",1),
    BUSINESSEDIT(2,"数据资产","编辑业务对象",4,"编辑业务对象", "businessedit", "businessedit",0),
    BUSINESSMANAGE(2,"数据资产","业务对象管理",5,"业务对象管理", "businessmanage", "businessmanage",0),
    BUSINESSADMIN(2,"数据资产","管理业务对象",9,"管理业务对象", "businessadmin", "businessadmin",1),
