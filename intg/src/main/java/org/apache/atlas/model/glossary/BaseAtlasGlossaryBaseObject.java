...
public abstract class BaseAtlasGlossaryBaseObject extends BaseAtlasBaseModelObject {
    ...
    public BaseAtlasGlossaryBaseObject() {
    }

    public BaseAtlasGlossaryBaseObject(final BaseAtlasGlossaryBaseObject other) {
        super(other);
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BaseAtlasGlossaryBaseObject)) return false;
        if (!super.equals(o)) return false;
        final BaseAtlasGlossaryBaseObject that = (BaseAtlasGlossaryBaseObject) o;
