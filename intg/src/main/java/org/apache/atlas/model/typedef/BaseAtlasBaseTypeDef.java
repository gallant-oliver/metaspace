...
public abstract class BaseAtlasBaseTypeDef implements java.io.Serializable {
    ...
    protected BaseAtlasBaseTypeDef(TypeCategory category, String name, String description, String typeVersion,
    ...
    protected BaseAtlasBaseTypeDef(BaseAtlasBaseTypeDef other) {
        if (other != null) {
    ...
    public boolean equals(Object o) {
        ...
        BaseAtlasBaseTypeDef that = (BaseAtlasBaseTypeDef) o;
