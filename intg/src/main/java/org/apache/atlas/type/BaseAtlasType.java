...
public abstract class BaseAtlasType {
    private static final Logger LOG = LoggerFactory.getLogger(BaseAtlasType.class);
    ...
    protected BaseAtlasType(BaseAtlasBaseTypeDef typeDef) {
        this(typeDef.getName(), typeDef.getCategory(), typeDef.getServiceType());
    }

    protected BaseAtlasType(String typeName, TypeCategory typeCategory, String serviceType) {
