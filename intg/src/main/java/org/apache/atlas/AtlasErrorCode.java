...
public enum AtlasErrorCode {
    ...
    TENANT_ERROE(400,"METASPACE-401-00-002","租户异常，租户id为空"),

    MESSAGE_DETAIL_RESULT(400, "METASPACE-400-00-003", "获取消息详情失败"),
    MESSAGE_URREAD_RESULT(400, "METASPACE-400-00-004", "获取未读消息数量失败"),
    MESSAGE_UPDATE_COUNT_RESULT(400, "METASPACE-400-00-005", "消息更新数量为0"),
    MESSAGE_BATCH_READ_RESULT(400, "METASPACE-400-00-006", "批量已读失败"),
    MESSAGE_BATCH_DELETE_RESULT(400, "METASPACE-400-00-007", "批量删除失败"),
    MESSAGE_ADD_RESULT(400, "METASPACE-400-00-008", "新增消息失败"),
    CATEGORY_NAME_SAME_ERROR(400, "METASPACE-400-00-008", "存在相同的目录名"),
    TABLE_RELATION_ERROR(400, "METASPACE-400-00-008", "获取关联表失败"),
    BUSINESS_OBJECT_LIST_ERROR(400, "METASPACE-400-00-008", "获取业务对象列表失败"),
    SEARCH_BUSINESS_OBJECT_ERROR(400, "METASPACE-400-00-008", "搜索业务对象失败");
