...
public enum AtlasErrorCode {
    ...
    MESSAGE_DETAIL_RESULT(500, "METASPACE-401-00-003", "获取消息详情失败"),
    MESSAGE_URREAD_RESULT(500, "METASPACE-401-00-004", "获取未读消息数量失败"),
    ...
    TABLE_RELATION_ERROR(500, "METASPACE-500-00-008", "获取关联表失败"),
    BUSINESS_OBJECT_LIST_ERROR(500, "METASPACE-500-00-008", "获取业务对象列表失败"),
    SEARCH_BUSINESS_OBJECT_ERROR(500, "METASPACE-500-00-008", "搜索业务对象失败");
