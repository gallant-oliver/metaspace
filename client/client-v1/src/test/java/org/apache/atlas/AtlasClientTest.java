...
public class AtlasClientTest {
    ...
    public void shouldVerifyServerIsReady() throws AtlasServiceException {
        ...
        WebResource.Builder builder = setupBuilder(AtlasClient.APIV1.VERSION, service);
        ...
        when(builder.method(AtlasClient.APIV1.VERSION.getMethod(), ClientResponse.class, null)).thenReturn(response);
    ...
    public void testCreateEntity() throws Exception {
        ...
        WebResource.Builder builder = setupBuilder(AtlasClient.APIV1.CREATE_ENTITY, service);
        ClientResponse response = mock(ClientResponse.class);
    ...
    private WebResource.Builder setupBuilder(AtlasClient.APIV1 api, WebResource webResource) {
    ...
    public void shouldReturnFalseIfServerIsNotReady() throws AtlasServiceException {
        ...
        AtlasClient atlasClient = new AtlasClient(service, configuration);
        WebResource.Builder builder = setupBuilder(AtlasClient.APIV1.VERSION, service);
        when(builder.method(AtlasClient.APIV1.VERSION.getMethod(), ClientResponse.class, null)).thenThrow(
    ...
    public void shouldGetAdminStatus() throws AtlasServiceException {
        ...
        WebResource.Builder builder = setupBuilder(AtlasClient.APIV1.STATUS, service);
        ClientResponse response = mock(ClientResponse.class);
        when(response.getStatus()).thenReturn(Response.Status.OK.getStatusCode());
        ...
        when(builder.method(AtlasClient.APIV1.STATUS.getMethod(), ClientResponse.class, null)).thenReturn(response);
...
//        atlasClient.setService();
    ...
    public void shouldSelectActiveAmongMultipleServersIfHAIsEnabled() {
        ...
        when(builder.method(AtlasClient.APIV1.STATUS.getMethod(), ClientResponse.class, null)).
    ...
    public void shouldRetryAPICallsOnClientHandlerException() throws AtlasServiceException, URISyntaxException {
        ...
        when(builder.method(AtlasClient.APIV1.LIST_TYPES.getMethod(), ClientResponse.class, null)).
        ...
        atlasClient.callAPIWithRetries(AtlasClient.APIV1.LIST_TYPES, null, resourceCreator);
