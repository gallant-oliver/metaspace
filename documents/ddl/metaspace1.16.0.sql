/*
 ...
 Source Server         : 10.202.63.28-TEST
...
COMMENT ON COLUMN "public"."api"."api_key" IS 'api测试的token';
...
CREATE TABLE "public"."businessinfo" (
  ...
  "submitter_read" bool,
  "process_name" varchar(255) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "system_file_name" varchar(255) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
CREATE TABLE "public"."message_center" (
  ...
  "update_time" timestamp(6),
  "delete" bool,
  "process" int2 NOT NULL DEFAULT 6
)
;
...
COMMENT ON COLUMN "public"."tableinfo"."source_id" IS '源id(已废弃)';
...
-- ----------------------------
-- Indexes structure for table data_quality_task_rule_execute
-- ----------------------------
CREATE INDEX "data_quality_task_rule_execute_create_time_idx" ON "public"."data_quality_task_rule_execute" USING btree (
...
-- ----------------------------
-- Primary Key structure for table shedlock
-- ----------------------------
ALTER TABLE "public"."shedlock" ADD CONSTRAINT "shedlock_pkey" PRIMARY KEY ("name");
...
-- ----------------------------
-- Indexes structure for table tableinfo
-- ----------------------------
...
-- ----------------------------
ALTER TABLE "public"."users" ADD CONSTRAINT "user_pkey" PRIMARY KEY ("account");
