 ...
 *
 */
public abstract class BaseTinkerpopGraphQuery<V, E> implements AtlasGraphQuery<V, E> {

    private static final Logger LOG = LoggerFactory.getLogger(BaseTinkerpopGraphQuery.class);
     ...
     * @param graph
     */
    public BaseTinkerpopGraphQuery(AtlasGraph<V, E> graph) {
        this.graph = graph;
     ...
     * @param isChildQuery
     */
    public BaseTinkerpopGraphQuery(AtlasGraph<V, E> graph, boolean isChildQuery) {
        this.graph = graph;
    ...
    public AtlasGraphQuery<V, E> or(List<AtlasGraphQuery<V, E>> childQueries) {
        ...
        for(AtlasGraphQuery<V, E> atlasChildQuery : childQueries) {
            ...
            BaseTinkerpopGraphQuery<V, E> childQuery = (BaseTinkerpopGraphQuery<V, E>)atlasChildQuery;
    ...
    public AtlasGraphQuery<V, E> addConditionsFrom(AtlasGraphQuery<V, E> otherQuery) {
        ...
        BaseTinkerpopGraphQuery<V, E> childQuery = (BaseTinkerpopGraphQuery<V, E>)otherQuery;
