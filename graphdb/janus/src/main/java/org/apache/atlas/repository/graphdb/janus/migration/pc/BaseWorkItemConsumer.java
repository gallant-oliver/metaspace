...
public abstract class BaseWorkItemConsumer<T> implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(BaseWorkItemConsumer.class);
    ...
    public BaseWorkItemConsumer(BlockingQueue<T> queue) {
        this.queue = queue;
    }
