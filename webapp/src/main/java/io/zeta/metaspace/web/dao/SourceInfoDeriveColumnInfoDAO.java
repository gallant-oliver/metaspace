...
public interface SourceInfoDeriveColumnInfoDAO {
    ...
    @Insert({"<script>",
            ...
            " secret, secret_period, important, remark, tenant_id, table_guid) ",
    ...
    @Insert({"<script>",
            ...
            " remark = excluded.remark,tenant_id = excluded.tenant_id,table_guid= excluded.table_guid",
            "</script>"})
