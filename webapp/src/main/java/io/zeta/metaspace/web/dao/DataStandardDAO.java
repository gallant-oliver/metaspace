...
public interface DataStandardDAO {
    ...
    @Select({"<script>",
             ...
             " <if test=\"params.query != null and params.query!=''\">",
             " and (c.username like concat('%',#{params.query},'%') ESCAPE '/' or b.number like concat('%',#{params.query},'%') ESCAPE '/' or b.content like concat('%',#{params.query},'%') ESCAPE '/' or b.description like concat('%',#{params.query},'%') ESCAPE '/') ",
             " </if>",
             " <if test=\"params.categoryId != null and params.categoryId!=''\">",
    ...
    @Select({"<script>",
             ...
             " and (u.username like concat('%',#{query},'%') ESCAPE '/' or d.number like concat('%',#{query},'%') ESCAPE '/' or d.content like concat('%',#{query},'%') ESCAPE '/' or d.description like concat('%',#{query},'%') ESCAPE '/') ",
             " order by version",
