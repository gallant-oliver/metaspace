...
public interface CategoryDAO {
    ...
    @Select("select * from category where categoryType=#{categoryType} and tenantid=#{tenantId} and level = 1")
    public Set<CategoryEntityV2> getAllByLevel(@Param("categoryType") int categoryType, @Param("tenantId") String tenantId) throws SQLException;
    ...
    @Select("select * from category where guid=#{guid} and tenantid=#{tenantId}")
    public CategoryPrivilege queryByGuidV2(@Param("guid") String categoryGuid, @Param("tenantId") String tenantId);
