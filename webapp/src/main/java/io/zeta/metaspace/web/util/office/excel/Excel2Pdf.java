...
//      table.setWidthPercentage(new float[]{100} , writer.getPageSize());
    ...
    public static void main(String[] args) throws MalformedURLException, DocumentException, IOException {
    	String fileIn = "D:\\workspace\\excel2pdf-master\\src\\test\\resources\\com\\github\\caryyu\\excel2pdf\\sample1\\case1.xls";
    	fileIn = "C:\\Users\\Gridsum\\Desktop\\daily_file\\测试excel.xls";
        InputStream in = new FileInputStream(new File(fileIn));
        Excel2Pdf excel2Pdf = new Excel2Pdf(Arrays.asList(
                new ExcelObject(in)
        ), new FileOutputStream(new File("C:\\Users\\Gridsum\\Desktop\\daily_file\\测试excel-1.pdf")));
        excel2Pdf.convert();
	}
}