...
public interface DatabaseInfoDAO {
    ...
    @Select("SELECT\n" +
            ...
            "LEFT JOIN db_info db ON s.database_id = db.database_id\n" +
            "LEFT JOIN source_db sd ON sd.db_guid = db.database_id\n" +
    ...
    DatabaseInfoBO getDatabaseInfoById(@Param("id") String id,@Param("tenantId") String tenantId,@Param("version") String version);
    ...
    @Select("")
    List<DatabaseInfoForCategory> getDatabaseInfoByIds(List<String> idList);
}
