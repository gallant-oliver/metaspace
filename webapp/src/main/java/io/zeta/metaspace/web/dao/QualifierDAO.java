...
public interface QualifierDAO {
    ...
    @Select({"<script>",
            ...
            " and (qualifier.name like concat('%',#{params.query},'%')  ESCAPE '/' or qualifier.mark like concat('%',#{params.query},'%') ESCAPE '/')",
            " </if>",
    ...
    @Select({"<script>",
            ...
            " qualifier.tenantId=#{tenantId} ",
            " <if test=\"params.query != null and params.query!=''\">",
            " and (qualifier.name like concat('%',#{params.query},'%') ESCAPE '/' )",
            " </if>",
