...
public interface TimeLimitDAO {
    ...
    @Select({"<script>",
            ...
            "    and (time_limit.name like concat('%',#{params.query},'%') ESCAPE '/' or time_limit.mark like concat('%',#{params.query},'%') ESCAPE '/')",
            " </if>",
    ...
    @Select({"<script>",
            ...
            " <if test=\"params.query != null and params.query!=''\">",
            " and time_limit.name like concat('%',#{params.query},'%') ESCAPE '/'",
            " </if>",
    ...
    @Select({"<script>",
            ...
            " <if test=\"params.query != null and params.query!=''\">",
            " and name like concat('%',#{params.query},'%') ESCAPE '/' or time_limit.mark like concat('%',#{params.query},'%') ESCAPE '/'",
            " </if>",
