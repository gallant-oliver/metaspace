...
public interface TaskManageDAO {
    ...
    @Select("select id as taskId,name as taskName,level,description,execution_count as executeCount,general_warning_total_count as generalWarningTotalCount,orange_warning_total_count as orangeWarningTotalCount,red_warning_total_count as redWarningTotalCount,error_total_count as errorTotalCount,start_time as startTime,end_time as endTime,pool,current_execution_percent as percent from data_quality_task where id=#{taskId}")
